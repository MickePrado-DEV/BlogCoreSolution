...
using BlogCoreSolution.Utilities;
...
namespace BlogCore.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            RoleManager<IdentityRole> roleManamger)
        {
        ...
        public class InputModel
        {
            ...
            [Required(ErrorMessage = "El telefono es obligatiorio")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        if (rol == CNT.Registered)
                        {
                            await _userManager.AddToRoleAsync(user, CNT.Registered);
                        }
                        else
                        {
                            await _userManager.AddToRoleAsync(user, CNT.Client);
                        }
